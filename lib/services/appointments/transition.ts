...
const NEXT: Record<AppointmentStatus, AppointmentStatus[]> = {
  [APPOINTMENT_STATUSES.UNPAID]: [APPOINTMENT_STATUSES.PENDING, APPOINTMENT_STATUSES.CANCELLED],
  [APPOINTMENT_STATUSES.PENDING]: [APPOINTMENT_STATUSES.PENDING_MATCH, APPOINTMENT_STATUSES.UNPAID, APPOINTMENT_STATUSES.CANCELLED],
  [APPOINTMENT_STATUSES.PENDING_MATCH]: [APPOINTMENT_STATUSES.MATCHED_PENDING_THERAPIST_ACCEPTANCE, APPOINTMENT_STATUSES.CANCELLED],
  ...
  [APPOINTMENT_STATUSES.CONFIRMED]: [APPOINTMENT_STATUSES.COMPLETED, APPOINTMENT_STATUSES.CANCELLED, APPOINTMENT_STATUSES.NO_SHOW, APPOINTMENT_STATUSES.RESCHEDULED],
...
export async function transitionAppointment(
  ...
  console.log('Transition debug:', {
    ...
    canTransition: allowed.includes(to)
  });
