import {
  ...
  export default function PatientAssignmentEmail({
    therapistName,
    patientName,
    appointmentDate,
    plan,
    ...
    return (
      <Html>
        <Head />
        <Preview>New Therapist Assignment</Preview>
        <Body style={main}>
          <Container style={container}>
            <Heading style={h1}>New Patient Assignment</Heading>
            <Text style={text}>Dear. {patientName},</Text>
            <Text style={text}>
              You have been assigned a new therapist, please check your account and book your appointment.
            </Text>
            ...
            <Text style={text}>
              Please review and book your appointment in your dashboard.
            </Text>
